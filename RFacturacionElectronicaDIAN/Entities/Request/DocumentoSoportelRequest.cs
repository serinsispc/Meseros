...
{
    public class DocumentoSoportelRequest:Acceso
    {
        ...
        public Resolution_DS resolution { get; set; }
        public Customer_DS customer { get; set; }
        public LegalMonetaryTotals_DS legal_monetary_totals { get; set; }
        public List<PaymentForms_DS> payment_forms { get; set; }
        public List<InvoiceLines_DS> invoice_lines { get; set; }
        public List<Notas_DS> notes { get; set; }
        public TaxTotal_DS tax_totals { get; set; }
        public Invoice_Period_DS invoice_eriod { get; set; }
        public class Resolution_DS
        {
        ...
        public class Invoice_Period_DS
        {
            public string start_date { get; set; }
            public int form_generation_transmission_id { get; set; }
        }
        public class Customer_DS
        {
            /// <summary>
        ...
        public class AllowanceCharge_DS
        {
        ...
        public class LegalMonetaryTotals_DS
        {
        ...
        public class InvoiceLines_DS
        {
            public int unit_measure_id { get; set; }
            public string invoiced_quantity { get; set; }
            public string line_extension_amount { get; set; }
            public List<AllowanceCharge_DS> allowance_charges { get; set; }
            public List<TaxTotal_DS> tax_totals { get; set; }
            public Invoice_Period_DS invoice_period { get; set; }
        ...
        public class Notas_DS
        {
            public string text { get; set; }
        }
        public class PaymentForms_DS
        {
