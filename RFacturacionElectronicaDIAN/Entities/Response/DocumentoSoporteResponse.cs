...
{
    public class Discrepancy_responseDS
    {
    ...
    public class LegalMonetaryTotalsDS
    {
    ...
    public class Billing_referenceDS
    {
        public string number { get; set; }
        public string uuid { get; set; }
        public string issue_date { get; set; }
    }
    public class PayloadDS
    {
    ...
    public class DocumentoSoporteResponse
    {
        ...
        public PayloadDS payload { get; set; }
    }
}
