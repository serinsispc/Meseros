...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            .cliente-modal .tabla-clientes thead{
                display: none;
            }
            .cliente-modal .tabla-clientes tbody tr{
                display: grid;
            ...
            .cliente-modal .tabla-clientes tbody td::before{
                                    ...
                                    <asp:Repeater ID="rptClientesModal" runat="server">
                                        <ItemTemplate>
                                            <tr class="cliente-row" tabindex="0"
                                                ...
                                                <td data-label="Tipo Documento"><%# Eval("TipoDocumento") %></td>
                                                <td data-label="NIT"><%# Eval("Nit") %></td>
                                                <td data-label="Nombre Cliente"><%# Eval("NombreCliente") %></td>
                                                <td data-label="Correo"><%# Eval("Correo") %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </tbody>
